...
class Templates { // TODO add more templates
  ...
  static Document minArticle({BuildContext? context}) => Document(null, context != null ? AppLocalizations.of(context)!.minArticleTitle : l10n.minArticleTitle, context != null ? AppLocalizations.of(context)!.minArticleContents(settingsController.defDocFont, settingsController.authorName) : l10n.minArticleContents(settingsController.defDocFont, settingsController.authorName), saved: false);

  static Document minReport({BuildContext? context}) => Document(null, context != null ? AppLocalizations.of(context)!.minReportTitle : l10n.minReportTitle, context != null ? AppLocalizations.of(context)!.minReportContents(settingsController.defDocFont, settingsController.authorName) : l10n.minReportContents(settingsController.defDocFont, settingsController.authorName), saved: false);

  static Document minBook({BuildContext? context}) => Document(null, context != null ? AppLocalizations.of(context)!.minBookTitle : l10n.minBookTitle, context != null ? AppLocalizations.of(context)!.minBookContents(settingsController.defDocFont, settingsController.authorName) : l10n.minBookContents(settingsController.defDocFont, settingsController.authorName), saved: false);
